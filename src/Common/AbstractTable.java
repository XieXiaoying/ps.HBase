...
public abstract class AbstractTable{
	...
	public Result get(byte[] rowKey, List<byte[]> cfList, List<Column> columnList, int versionNum ){
		Get get = new Get(rowKey);
	 ...
	 * 
	 * */
	public void deleteColumn(byte[] rowKey, byte[] familyName,
			byte[] columnName){
		Delete delete = new Delete(rowKey);
		delete.deleteColumn(familyName, columnName);
		try {
		...
		System.out.println(Bytes.toString(rowKey) + "  " + Bytes.toString(familyName) + " and " + Bytes.toString(columnName) + " is deleted !! ");
	}
	...
	public void deleteTable(String tableName){
		try {
			admin = new HBaseAdmin(Constants.conf);
