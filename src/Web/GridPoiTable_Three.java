 ...
 * 
 * */
public class GridPoiTable_Three extends AbstractTable{
	Logger logger = Logger.getLogger(GridPoiTable_Three.class);
	...
	private static final String tableName = "gridPoi333";
	
	
	public GridPoiTable_Three(){
		try{
...
//		GridPoiTable_Three gridTable_three = new GridPoiTable_Three();
...
//				if(lat!=0&&lon!=0){
//					address = Geocoder.gps2SegmentAdressForGridPoiTable_Three(lat,lon);
//					System.out.println("\n该站地址:"+address);
//				}
//			}
//			
...
//				gridTable_three.setLargeGrid(lat, lon, null, timeDate,
//						pm,subPoi,pic_url);
//				
//			}
//		}
...
//		gridTable_Three.updateLargeGrid(39.759723, 116.352423, null, timeDate, "111", "000", "test_2.png");
//		gridTable_Three.updateLargeGrid(40.869733, 117.462433, null, timeDate, "222", "000", "test_2.png");
//		gridTable_Three.updateLargeGrid(41.979743, 118.572443, null, timeDate, "333", "000", "test_2.png");
