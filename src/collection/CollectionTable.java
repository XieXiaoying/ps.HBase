...
public class CollectionTable extends AbstractTable{
	...
	public List<JSONObject> getlight(double lat, double lon, String time, int countlimt, 
		...
		for(Result result : results){
			...
			oJsonObject.accumulate("time",timeDate);
	...
	/*	for(String filePath : args){
		...
		//ct.importFakeData("resource/txt/tbl_traj_new.txt");
		
		ct.getlight(39.9995710000, 116.3193190000,"2015-5-12 00:35:13", 30, 1);
